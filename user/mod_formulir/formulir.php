                    ...
                    <div class="tab-content" id="myTabContent2">
                        <div class="tab-pane fade show active" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                            <form id="form-datadiri">
                                ...
                                <div class="form-group row mb-2">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Pilihan Program</label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="tgllahir" value="<?= tgl_indo($siswa['tgl_lahir']) ?>" disabled > <br>*tanggal lahir tidak bisa diubah, jika terdapat kesalahan silahkan menghubungi admin.
                                    </div>
                                </div>
                                <div class="form-group row mb-2">
                        ...
                        <div class="tab-pane fade" id="contact3" role="tabpanel" aria-labelledby="contact-tab3">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="form-group row mb-2">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" name="alamat" class="form-control" value="<?= $siswa['alamat'] ?>" placeholder="nama blok / kampung" >
                                    </div>
                                </div>
                                <div class="form-group row mb-2">

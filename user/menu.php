<ul class="sidebar-menu">
    <li class="menu-header bg-warning"></li>
		...
		<?php } else { ?>
		<li><a class="nav-link" href="?pg=df_ulang"><i class="fas fa-address-card   "></i> <span>Daftar Ulang</span><small class="label pull-right badge badge-succes">sudah</small></a></li>
		<?php } ?>

<ul class="sidebar-menu">
    ...
    <?php 
    if ($siswa['status'] == 0 || $siswa['status'] == '' || is_null($siswa['status'])) { ?>
        <li>
            <a class="nav-link" href="?pg=df_ulang">
                <i class="fas fa-address-card"></i> <span>Daftar Ulang</span>
                <small class="label pull-right badge badge-danger">wajib</small>
            </a>
        </li>
    <?php } else { ?>
        <li>
            <a class="nav-link" href="?pg=df_ulang">
                <i class="fas fa-address-card"></i> <span>Daftar Ulang</span>
                <small class="label pull-right badge badge-success">sudah</small>
            </a>
        </li>
    <?php } ?>

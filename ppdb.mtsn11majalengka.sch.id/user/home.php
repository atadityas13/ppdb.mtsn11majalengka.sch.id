                ...
                <div class="activities">
                    <div class="activity">
                        ...
                        <div class="activity-detail">
						   ...
						   <?php } else { ?>
						  <a target="" type="button" class="badge badge-info" data-confirm="Maaf Konfirmasi Daftar Ulang Belum bisa di lakukan !!| Status anda Masih Proses Verifikasi.." ><i class="fas fa-eye    "></i>Konfirmasi</a
						   <!-- Modal -->
				...
				<div class="box-body">
					...
					<ul class="list-group">
						<li class="list-group-item"><img src="../dist/img/support.png" width="45" alt="">
							<a href="https://mtsn11majalengka.sch.id/" target="_blank" class="btn btn-success">
								<i class="fas fa-globe    "></i> Website Sekolah
							</a></li>
						<li class="list-group-item"><img src="../dist/img/support.png" width="45" alt="">
							<a href="https://api.whatsapp.com/send?phone=<?= $setting['nolivechat'] ?>&text=<?= $setting['livechat'] ?>" target="_blank" class="btn btn-primary">

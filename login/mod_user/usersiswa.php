                                                    ...
                                                    <form id="form-edit<?= $no ?>">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="nama" value="<?= $daftar['nama'] ?>" class="form-control" required="">
                                                            </div>
                                                            <div class="form-group">
                                                                <label>Username</label>
                                                                <input type="text" name="no_siswa" value="<?= $daftar['nisn'] ?>" class="form-control" required="">
                                                            </div>
                                                            
                                                            <div class="form-group">
                                                                <label>Ganti Password</label>
                                                                 <input type="text" name="password" value="<?= $daftar['password'] ?>" class="form-control" required="">
                                                            </div>

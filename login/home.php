...
// Ambil pengumuman dari tabel pengumuman    
$query_pengumuman = mysqli_query($koneksi, "SELECT pengumuman FROM pengumuman ORDER BY id_pengumuman DESC LIMIT 1");    
$pengumuman = mysqli_fetch_assoc($query_pengumuman);    
$pengumuman_text = $pengumuman['pengumuman'] ?? 'Tidak ada pengumuman saat ini.';  
$tatacara_text = '
1. Klik Data Pendaftar pada menu PPDB;<br>
2. Klik tambah data dan masukan data pendaftar kemudian save;<br>
3. Lengkapi data siswa pendaftar dengan klik tombol aksi detail siswa;<br>
4. Cetak bukti pendaftaran;<br>
5. Untuk pendaftaran kolektif serahkan bukti hasil download Excell pada Aplikasi kepada panitia PPDB ditandatangani Kepala Sekolah.'; 
// Debugging: Cek nilai pengumuman_text  
...
<div class='row'>    
    ...
    <?php } elseif ($is_operator_sd) { ?>    
        <div class="col-lg-3">    
            <div class="small-box bg-blue">    
                <div class="inner">    
                    <h3><?= rowcount($koneksi, "daftar WHERE npsn_asal = '{$id_sekolah}'") ?></h3>    
                    <p>Jumlah Pendaftar</p>    
                </div>    
                <div class="icon">    
                    <i class="fa fa-users"></i>    
        ...
        <div class="col-lg-3">    
            <div class="small-box bg-yellow">    
                <div class="inner">    
                    <h3><?= rowcount($koneksi, "daftar WHERE npsn_asal = '{$id_sekolah}' AND status = 0") ?></h3>    
        ...
        <div class="col-lg-3">    
            <div class="small-box bg-green">    
                <div class="inner">    
                    <h3><?= rowcount($koneksi, "daftar WHERE npsn_asal = '{$id_sekolah}' AND status = 1") ?></h3>    
            ...
            <div class="small-box bg-red">    
                <div class="inner">    
                    <h3><?= rowcount($koneksi, "daftar WHERE npsn_asal = '{$id_sekolah}' AND status = 2") ?></h3>    
        ...
        <?php } elseif ($is_operator_sd) { ?>    
            <div class="card">    
                <div class="alert alert-info alert-has-icon">    
                    <div class="alert-icon"><i class=""></i></div>    
                    <div class="alert-body">    
                        <div class="alert-body">Informasi</div>    
                    </div>    
                </div>    
                <div class="card-body">    
                    <p><?= $pengumuman_text ?></p>    
            ...
            <div class="card">    
                <div class="alert alert-info alert-has-icon">    
                    <div class="alert-icon"><i class=""></i></div>    
                    <div class="alert-body">    
                        <div class="alert-body">Tata Cara Mendaftar</div>    
                    </div>    
                </div>    
                <div class="card-body">    
                    <p><?= $tatacara_text ?></p>    

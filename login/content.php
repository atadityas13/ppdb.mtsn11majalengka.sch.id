...
} elseif ($pg == 'berkas_sekolah') {
    include "mod_daftar/berkas_sekolah.php";
} elseif ($pg == 'daftar_sekolah') {
    include "mod_daftar/daftar_sekolah.php";
} elseif ($pg == 'l_ppdbyes') {
...
} elseif ($pg == 'data_sekolah') {
    include "mod_setting/profil_sekolah_sd.php";
} elseif ($pg == 'detail') {
